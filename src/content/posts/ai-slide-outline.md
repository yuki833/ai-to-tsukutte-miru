...
**確かめていないこと**も書いておきます。この構成案を実際にPowerPointへ移して上司に説明する、というところまではやっていません。**「資料作成の時間が減った」とは言えません。** 言えるのは、白紙の状態から5枚ぶんの見出しと中身の案が出て、そのうち6か所は自分で調べる必要がある、というところまでです。
...
**ここで作った構成案を、手で貼らずにPowerPointの5枚へ変えるところ**は、[プレゼン資料をAIに作らせる。下書きをPowerPointの5枚へ一度に流し込む](/articles/ai-presentation-slides/)に書きました。**この記事の第2章のアウトラインを、そのまま材料にしています。** 貼り付けの繰り返しが面倒だと感じたら、次はそちらへ。
