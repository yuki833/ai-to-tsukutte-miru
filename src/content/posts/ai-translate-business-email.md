...
**1章の【形】を、この2行に差し替えてください。**

```text
【形】件名と本文。件名だけで用件が分かるようにする
　　　本文は結論を先に書き、番号付きの3点にまとめる。1つの項目は3行以内
```
...
**何を伏せるかが分からないときは、貼る前にこれを聞いてください。**

```text
次のメールから、社外へ出したくない固有名詞と数字だけを抜き出してください。
抜き出すのは、①会社名 ②個人名 ③金額 ④数量 ⑤日付 の5つです。
本文は書き換えないでください。抜き出した一覧だけを返してください。

---
（ここに日本語のメールを貼る）
```

**出てきた一覧が、そのまま置き換え表の左側になります。**
...
**食い違いだけを出したいときは、4章の答えのあとにこれを貼ってください。**

```text
いま挙げてもらった「相手の理解」と、次の日本語の原文で伝えたかったことを
並べて、食い違う点だけを表にしてください。
食い違いが無い項目は、表に載せないでください。
